#!/usr/bin/env python3
"""
Git sync job for the Agent Workflow UI CML deployment.

Root job in the CML job chain (see cai/jobs_config.yaml):
    git_sync  ->  setup_environment
...
CML auto-trigger the dependent setup_environment job.
...
def main() -> None:
    print("=" * 70)
    print("Agent Workflow UI — Git Sync")
    print("=" * 70)
